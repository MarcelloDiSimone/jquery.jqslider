...
(function ($, window, document, undefined) {
    ...
    JQSlider.prototype = {
         ...
         * @param {jQuery} current              jQuery element of the slide that was animated out
         * @param {jQuery} next                 jQuery element of the slide that was animated in
         * @private
         */
         ...
         * @return {jQuery} returns the jquery object of the slide with the passed index
         */
    ...
    /**
     * Initialize each object of the jQuery set as an instance of JQSlider, sets a reference to the instance
